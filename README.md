...
This konnector retrieves your banking data from N26 bank.
...
cozy-konnector-n26 is developed by [Orandin](https://github.com/orandin) and distributed under the [AGPL v3 license][agpl-3.0].
